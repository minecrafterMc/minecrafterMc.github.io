...
function readCustomCards()
{
  ...
  while (i != customCardAmmount)
  {
    ...
    if (document.getElementById("CardSigils" + i).value == "" || document.getElementById("CardSigils" + i).value == "ndefine")
    {
...
{
  let file = document.getElementById("externalRuleset").files[0];
  let reader = new FileReader();
    reader.readAsText(file, "UTF-8");
    reader.onload = function (evt) {
      json = JSON.parse(evt.target.result);
      console.log(json);
      document.getElementById("name").value = json.ruleset;
      document.getElementById("hammers").value = json.hammers_per_turn;
      document.getElementById("maxAnts").value = json.ant_limit;
      document.getElementById("mindeck").value = json.deck_size_min;
      document.getElementById("max_commons_main").value = json.max_commons_main;
      document.getElementById("max_commons_side").value = json.max_commons_side;
      document.getElementById("lives").value = json.num_candles;
      document.getElementById("allow_snuffing_candles").checked = json.allow_snuffing_candles;
      document.getElementById("opt_activities").checked = json.opt_activities;
      document.getElementById("image").value = json.portrait;
...
{
  let i = 1;
  while (i != json.cards.length + 1)
  {
    addNewCard();
    document.getElementById("CardName" + i).value = json.cards[i - 1].name;
    delete json.cards[i - 1].name;
    document.getElementById("CardDesc" + i).value = json.cards[i - 1].description;
    delete json.cards[i - 1].description;
    document.getElementById("CardAttack" + i).value = json.cards[i - 1].attack;
    delete json.cards[i - 1].attack;
    document.getElementById("CardHealth" + i).value = json.cards[i - 1].health;
    delete json.cards[i - 1].health;
    document.getElementById("CardBanned" + i).checked = json.cards[i - 1].banned;
    delete json.cards[i - 1].banned;
    document.getElementById("CardRare" + i).checked = json.cards[i - 1].rare;
    delete json.cards[i - 1].rare;
    document.getElementById("CardNoSac" + i).checked = json.cards[i - 1].nosac;
    delete json.cards[i - 1].nosac;
    document.getElementById("CardSigils" + i).value = JSON.stringify(json.cards[i - 1].sigils);
    document.getElementById("CardSigils" + i).value = (document.getElementById("CardSigils" + i).value).slice(0,-1);
    document.getElementById("CardSigils" + i).value = (document.getElementById("CardSigils" + i).value).slice(1);
    delete json.cards[i - 1].sigils;
    if (json.cards[i - 1].blood_cost != undefined)
    {
      document.getElementById("CardCost" + i).value = 1;
      document.getElementById("CardAmountCost" + i).value = json.cards[i - 1].blood_cost;
      delete json.cards[i - 1].blood_cost;
    }
    else if (json.cards[i - 1].bone_cost != undefined)
    {
      document.getElementById("CardCost" + i).value = 2;
      document.getElementById("CardAmountCost" + i).value = json.cards[i - 1].bone_cost;
      delete json.cards[i - 1].bone_cost;
    }
    else if (json.cards[i - 1].energy_cost != undefined)
    {
      document.getElementById("CardCost" + i).value = 3;
      document.getElementById("CardAmountCost" + i).value = json.cards[i - 1].energy_cost;
      delete json.cards[i - 1].energy_cost;
    }
    else if (json.cards[i - 1].nox_cost != undefined)
    {
      document.getElementById("CardCost" + i).value = 4;
      document.getElementById("CardAmountCost" + i).value = JSON.stringify(json.cards[i - 1].nox_cost);
      document.getElementById("CardAmountCost" + i).value = (document.getElementById("CardAmountCost" + i).value).slice(0,-1);
      document.getElementById("CardAmountCost" + i).value = (document.getElementById("CardAmountCost" + i).value).slice(1);
      delete json.cards[i - 1].nox_cost;
    }
    document.getElementById("CardBonus" + i).value = JSON.stringify(json.cards[i - 1]);
    document.getElementById("CardBonus" + i).value = (document.getElementById("CardBonus" + i).value).slice(1,-1)
    i += 1;
  }
}